        ...
        "/aoc/account-types": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Sort field: code or name",
                        "name": "sort",
                        "in": "query"
                    },
                    {
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/domain.AccountTax"
                        }
                    },
                    "500": {
                        "description": "Internal Server Error",
    ...
    "definitions": {
        ...
        "domain.Clinic": {
            ...
            "properties": {
                ...
                "methodType": {
                    "$ref": "#/definitions/domain.MethodType"
                },
                "name": {
                    "type": "string"
                },
                ...
                "shareType": {
                    "$ref": "#/definitions/domain.ShareType"
                },
                "state": {
                    "type": "string"
                },
        ...
        "domain.User": {
            ...
            "properties": {
                ...
                "password": {
                    "description": "Never return password in JSON",
                    "type": "string"
                },
                "phone": {
                    "type": "string"
