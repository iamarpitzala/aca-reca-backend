...
// func ConvertNormalizedToJSONB(normalized *NormalizedEntry) (*FieldEntry, error) {
...
// 		CustomFormFieldID: normalized.Header.CustomFormFieldID,
// 		Value:             normalized.Header.Value,
...
// func ConvertJSONBToNormalized(entry *FieldEntry, form *CustomForm) (*NormalizedEntry, error) {
// 	if entry == nil {
// 		return nil, nil
// 	}
...
// 			ID:                entry.ID,
// 			FormID:            entry.FormID,
// 			CustomFormFieldID: entry.CustomFormFieldID,
// 			Value:             entry.Value,
...
// 	if len(normalized.FieldValues) > 0 {
// 		for i, v := range normalized.FieldValues {
// 			fv := EntryFieldValue{
// 				ID:              v.ID,
// 				EntryID:         v.EntryID,
// 				FieldID:         v.FieldID,
...
// 				ManualGstAmount: v.ManualGstAmount,
// 				DisplayOrder:    i,
...
// 	normalized.NetDetails = parseNetDetailsFromCalc(entry, calc, ded)
// 	normalized.GrossDetails = parseGrossDetailsFromCalc(entry, calc, ded)
