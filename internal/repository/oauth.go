...
func UpdateOrCreateOAuthProvider(ctx context.Context, db *sqlx.DB, oauthProvider *domain.OAuthProvider, provider string, providerUserID string, userID uuid.UUID, token *oauth2.Token) (bool, error) {
