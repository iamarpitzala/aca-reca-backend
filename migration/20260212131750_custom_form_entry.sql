...
-- Create tbl_custom_form_entry table (required before transaction migration)
...
CREATE INDEX IF NOT EXISTS idx_custom_form_entry_form_id ON tbl_custom_form_entry(form_id);
CREATE INDEX IF NOT EXISTS idx_custom_form_entry_clinic_id ON tbl_custom_form_entry(clinic_id);
CREATE INDEX IF NOT EXISTS idx_custom_form_entry_quarter_id ON tbl_custom_form_entry(quarter_id);
CREATE INDEX IF NOT EXISTS idx_custom_form_entry_entry_date ON tbl_custom_form_entry(entry_date);
CREATE INDEX IF NOT EXISTS idx_custom_form_entry_deleted_at ON tbl_custom_form_entry(deleted_at);
